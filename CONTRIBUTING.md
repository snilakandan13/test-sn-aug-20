...
**[SalesforceCommerceCloud/storefront-next](https://github.com/SalesforceCommerceCloud/storefront-next)**

### Step 2: Read the Monorepo Contributing Guidelines

The monorepo has detailed contribution guidelines:

**[Monorepo CONTRIBUTING.md](https://github.com/SalesforceCommerceCloud/storefront-next/blob/main/CONTRIBUTING.md)**
...
- 🔒 **Read-only**: This repo is protected against direct changes
- 🔄 **Automatic sync**: Changes are overwritten by automatic syncs
- ❌ **Changes lost**: Any direct changes would be lost on next sync
- ✅ **Single source**: Keeps monorepo as single source of truth
...
**[Open Issue in Monorepo](https://github.com/SalesforceCommerceCloud/storefront-next/issues/new)**
...
- **General questions**: Open a discussion in the [monorepo](https://github.com/SalesforceCommerceCloud/storefront-next/discussions)
- **Bug reports**: Open an issue in the [monorepo](https://github.com/SalesforceCommerceCloud/storefront-next/issues)
- **Feature requests**: Open an issue in the [monorepo](https://github.com/SalesforceCommerceCloud/storefront-next/issues)
