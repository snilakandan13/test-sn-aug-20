...
import * as DeliveryOptionsStories from './delivery-options.stories';
import { render, cleanup } from '@testing-library/react';
import { StoryTestWrapper } from '../../../../../../.storybook/test-wrapper';

const composed = composeStories(DeliveryOptionsStories);

afterEach(() => {
    cleanup();
});

describe('DeliveryOptions stories snapshot', () => {
