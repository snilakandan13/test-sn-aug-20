...
import * as HeroCarouselSkeletonStories from './skeleton.stories';
import { render, cleanup } from '@testing-library/react';

const composed = composeStories(HeroCarouselSkeletonStories);

afterEach(() => {
    cleanup();
});

describe('HeroCarouselSkeleton stories snapshot', () => {
